...
plots[-1].name = "TurnOn_SingleEG_LooseIsoEr_Run2018ABCD"
plots[-1].xRange = (0,99.9)
#plots[-1].legendPosition = (0.6,0.2,0.9,0.4)
plots[-1].legendPosition = (0.6,0.2,0.9,0.4)


inputFile = ROOT.TFile.Open("turnon_rootfiles/Efficiency_turnons_Data2018_SingleLooseIsoEG26er.root")

histo = inputFile.Get("histo_SingleLooseIsoEG26er")
...
inputFile = ROOT.TFile.Open("turnon_rootfiles/Efficiency_turnons_Data2018_SingleLooseIsoEG24er.root")

histo1 = inputFile.Get("histo_SingleLooseIsoEG24er")
