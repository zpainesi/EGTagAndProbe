...
/*****************************************************************/
void Utilities::tokenize(const string& str,
...
/*****************************************************************/
string Utilities::intToString(int n)
/*****************************************************************/
{
    ostringstream oss;
    oss << n;
...
/*****************************************************************/
void Utilities::findAndReplace(string& sInput, string sFind, string sReplace )
/*****************************************************************/
{
    size_t itPos = 0; 
...
/*****************************************************************/
void Utilities::strip(std::string& sInput)
/*****************************************************************/
{
