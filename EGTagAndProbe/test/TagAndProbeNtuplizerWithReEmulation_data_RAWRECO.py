...
if not isMC: # will use 80X
    ...
    process.source = cms.Source("PoolSource",
        ...
        '/store/data/Run2024I/EGamma0/RAW-RECO/ZElectron-PromptReco-v1/000/386/478/00000/02fa423a-3764-4290-9134-d33926ea6407.root'
        )
    )
...
process.load("L1Trigger.L1TCalorimeter.caloParams_2024_JAX_ECAL_107_newCalib_iEt_cfi")
